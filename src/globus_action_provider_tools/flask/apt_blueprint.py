...
class ActionProviderBlueprint(Blueprint):
    def __init__(
        ...
        **kwarg,
        ...
        :param globus_auth_client_name: Deprecated. This parameter does nothing.
    ...
    def _create_state_builder(self, setup_state: blueprints.BlueprintSetupState):
        ...
        # FIXME: NETWORK-BEHAVIOR
        # it needs to be possible to parametrize this client to control its network
